...
geometry_csv_path = '/home/emanuele/post_doc/ORION/safe/data/cable/location_cable_estepona-tetuan_interpolated.txt'
simplified_geometry_csv = '/home/emanuele/post_doc/ORION/safe/data/cable/simplified_geometry_kefalonia.csv'

#directory containing .mseed and .h5 files


#das_directory = '/home/emanuele/post_doc/codici/kefalonia/input_detected_events'
das_directory = '/home/emanuele/post_doc/ORION/safe/data/h5_sel'
...
# Combine all
names_and_paths = mseed_names_and_paths + h5_names_and_paths


#path to store the clustering resust to avoid repeating the spatial clustering step
clustering_save_path = '/home/emanuele/post_doc/ORION/safe/clustering_results.pkl'


def main():
    output_root = '/home/emanuele/post_doc/ORION/safe/output_orion'
