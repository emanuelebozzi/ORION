...
geometry_csv_path = '/home/emanuele/post_doc/ORION/safe/grimsvotn/latlonele_new.txt'
simplified_geometry_csv = '/home/emanuele/post_doc/ORION/safe/grimsvotn/simplified_geometry_grimsvotn.csv'

#directory containing .mseed and .h5 files


#das_directory = '/home/emanuele/post_doc/codici/kefalonia/input_detected_events'
das_directory = '/home/emanuele/post_doc/ORION/safe/grimsvotn'
...
npy_pattern = os.path.join(das_directory, 'GRIMSVOTN_DAS_ARRAY21_05_10_00_12_17.npy')      # for generic .npy files
...
clustering_save_path = '/home/emanuele/post_doc/ORION/safe/clustering_results_grimsvotn.pkl'


def main():
    output_root = '/home/emanuele/post_doc/ORION/safe/output_orion_grimsvotn'
