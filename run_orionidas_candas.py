...
geometry_csv_path = '/home/emanuele/post_doc/ORION/safe/candas_2/canalink_GC_interpolated.txt'
simplified_geometry_csv = '/home/emanuele/post_doc/ORION/safe/candas_2/simplified_geometry_candas_2.csv'

#directory containing .mseed and .h5 files


#das_directory = '/home/emanuele/post_doc/codici/kefalonia/input_detected_events'
das_directory = '/home/emanuele/post_doc/ORION/safe/candas_2'

# how names of the files are organized
mseed_pattern = os.path.join(das_directory, 'noa2024*_das.mseed')
h5_pattern = os.path.join(das_directory, 'CANDAS2_2023-01-07_10-48-10.h5')   # for kef0365.h5-style files
npy_pattern = os.path.join(das_directory, 'PSUDAS_UTC_20190827_0758285_0759285.npy')      # for generic .npy files
...
clustering_save_path = '/home/emanuele/post_doc/ORION/safe/clustering_results_candas_2.pkl'


def main():
    output_root = '/home/emanuele/post_doc/ORION/safe/output_orion_candas_2'
